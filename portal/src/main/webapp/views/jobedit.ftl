...
<html>
  ...
  <#include "nav.ftl">
      ...
      <div class="full height">
        <div class="toc" style="min-height: 100%;">
          <div class="ui vertical inverted sticky menu" style="left: 0px; top: 0px; width: 200px ! important; height: 100% ! important;">
            ...
            <a class="item" href="../queryui">
              <b><i class="icon level down"></i> Query UI</b>
            </a>
        ...
        <div class="ui main"  style="width: 100%;">
          <div style=" background-color: #EBEBEB; padding: 7px; text-align: right;">
            ...
            <button class="ui labeled icon  button  vk save" onclick="saveJob();" >
            <i class="save icon"></i>
            Save Job
            </button>
          </div>
    ...
    <div class="jobfunc" >
      ...
      <div class="ui styled fluid accordion">
        ...
        <div class="content active">
          ...
          <div style="margin-top:10px;">
            ...
            <div class="ui  checkbox csv storage">
              <input name="storage" checked="checked" type="checkbox" value="1">
          ...
          <div style="margin-top:10px;" id="save_to_db">
            ...
            <div class="ui right action left input labeled insert sql" style="width:75%;">
              ...
              <div class="ui basic floating dropdown button location db">
                <div class="text">Select DB Location</div>
                <i class="dropdown icon"></i>
                <div class="menu">
        ...
        <div class="title active chart">
          <i class="dropdown icon"></i>
          Chart Template
        </div>
        <div class="content active chart">
          <div class="ui secondary pointing menu chartfilter">
            <a class="item active all">
              All Chart
            </a>
            <a class="item line">
              <i class="icon line chart"></i> Line 
            </a>
            <a class="item bar">
              <i class="icon bar chart"></i>Bar
            </a>
            <a class="item pie">
              <i class="icon pie chart"></i>Pie
            </a> 
            <div class="right menu">
              <a class="ui item"  id="reloadchart" onclick="reloadChart()">
                <i class="icon repeat"></i>Update Table
              </a>
              <a class="ui item"  id="addchart">
                <i class="icon plus"></i>Add Chart Template
              </a>
            </div>           
          </div>
          
          <table class="ui celled inverted table chart">
          <thead>
            <tr>
              <th>Chart Name</th>
              <th>Chart Type</th>
      ...
      <h3>Job Delete</h3>
      <button class="ui labeled icon red button job delete">
      <i class="fire icon"></i>
      Delete Job
      </button>
    </div>
  ...
  <#-- Job Edit Function -->
  <script src="../dist/jobedit.js"></script>
</body>
</html>