 ...
 */
public  class OrcFileUtil  extends OrcFile{
    ...
    @Override
    public ByteArrayInputStream getInputStream(String path, int start, int end) {
        return readORCFiles(path,TYPE.HDFS,start,end);
    }
    /**
     *
