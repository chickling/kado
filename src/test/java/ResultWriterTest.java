...
import com.chickling.models.jdbc.dbselect.ManagerConfig;
...
//        futureList.add(service.submit(localWriter));
        futureList.add(service.submit(dbWriter));
...
//        doWriter(resultWriter);
    ...
    public  void testDBWriter() throws Exception {
        ...
        ResultWriter resultWriter=new DBWriter();
        resultWriter.init(parameter);
       int result= doWriter(resultWriter);

        assert  result==4;
        assert Strings.isEmpty(resultWriter.getException()) ;
    }
