...
public class YamlLoader {
	...
	private  String importBatchSize;
	private  String notbatchdb="";
	...
	public String getImportBatchSize() {
		return importBatchSize;
	}

	public void setImportBatchSize(String importBatchSize) {
	...
	public String toString() {
		return "YamlLoader{" +
				...
				", Batch size of SQL insert=" + importBatchSize +
				", Not Use Batch SQL DataBase=" + notbatchdb +
